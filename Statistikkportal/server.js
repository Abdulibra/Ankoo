                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                console.log(area);
                                return [4 /*yield*/, fetch("https://data.ssb.no/api/v0/no/table/11342?var=".concat(variable_1, "&Region=").concat(area, "&Contents&BrukereKilder=S&format=json"))];
                            case 1:
                                response = _a.sent();
                                if (!response.ok) {
...
//       //   return json.dataset.value; // Replace 'dataset' and 'value' with the actual properties in the API response
//       return json.variables.map((variable) => variable.values);
//     });
//     const data = await Promise.all(dataPromises);
//     // Calculate statistics here (median, average, max, min)
//     const median = calculateMedian(data.flat());
//     const average = calculateAverage(data.flat());
